...
<html lang="en">
  <head>
    ...
    <!-- this breaks iFrames rn, will fix soon prolly -->
    <!-- <script src="splash.guard.js"></script> -->
    ...
    <meta name="description" content="ap exam study guides" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://splash.rhw.one/" />
    <meta property="og:title" content="SPLASH" />
    <meta property="og:description" content="ap exam study guides" />
  ...
  <body class="mode-terminal">
    <div id="app">
      <div id="proxy-shell">
        <iframe id="proxy-frame" title="SPLASH into Computer Science :)"></iframe>
